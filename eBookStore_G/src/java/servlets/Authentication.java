...
public class Authentication extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Validator validator = new Validator(user,pass);
        ...
        if(validator.userExist)
        {
                ...
                request.getSession().setAttribute("actualUserRole", validator.role );
    ...
    public void  redirect(HttpServletRequest request,HttpServletResponse response,String page)
