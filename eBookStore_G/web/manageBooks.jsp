       ...
       <div class="content">
        ...
        <div class="contentt">
           ...
           <table class="ebooktable">
              ...
              <tr>
                <td>1</td>
                <td> <c:out value="${request.getRequestURI()}"  /></td>
                <td><c:out value="${pageContext.servletContext.contextPath}" /> sss </td>
                <td><c:out value="${pageContext.request.servletPath}" /> </td>
              </tr>
              <tr>
                <td>2</td>
                <td> <c:out value="${requestScope['javax.servlet.forward.servlet_path']}"  /></td>
                <td></td>
                <td></td>
              </tr>
              <tr>
